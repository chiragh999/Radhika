# Generated by Django 5.1.4 on 2025-02-03 09:23
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('advance_amount', models.CharField(max_length=150)),
                ('advance_payment_mode', models.CharField(choices=[('CASH', 'CASH'), ('CHEQUE', 'CHEQUE'), ('BANK_TRANSFER', 'BANK TRANSFER'), ('ONLINE', 'ONLINE'), ('OTHER', 'OTHER')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('advance_amount', models.DecimalField(decimal_places=0, max_digits=10)),
                ('pending_amount', models.DecimalField(blank=True, decimal_places=0, max_digits=10, null=True)),
                ('payment_date', models.DateField()),
                ('transaction_amount', models.DecimalField(decimal_places=0, max_digits=10)),
                ('payment_mode', models.CharField(choices=[('CASH', 'CASH'), ('CHEQUE', 'CHEQUE'), ('BANK_TRANSFER', 'BANK TRANSFER'), ('ONLINE', 'ONLINE'), ('OTHER', 'OTHER')], max_length=20)),
                ('settlement_amount', models.DecimalField(blank=True, decimal_places=0, max_digits=10, null=True)),
                ('payment_status', models.CharField(choices=[('PARTIAL', 'Partial'), ('UNPAID', 'Unpaid'), ('PAID', 'Paid')], default='UNPAID', max_length=10)),
                ('note', models.TextField(blank=True)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('billed_to', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='payments', to='app.eventbooking', unique=True)),
            ],
            options={
                'constraints': [models.UniqueConstraint(fields=('billed_to',), name='unique_billed_to')],
            },
        ),
    ]
